    ...
    <div class="statics">
      <table>
        <tr>
          <td>
            <div
              :class="foucusDetailClass"
              @click="openPop('FOUCUS')"
              @mouseover="mouseOver('FOUCUS')"
              @mouseleave="mouseLeave('FOUCUS')"
            >
              重点关注
            </div>
          </td>
          ...
          <td>
            <div
              :class="removeAlertClass"
              @mouseover="mouseOver('REMOVEALERT')"
              @mouseleave="mouseLeave('REMOVEALERT')"
              @click="openPop('REMOVEALERT')"
            >
              拆除报警
            </div>
          </td>
          <td>
            <div
              :class="lossElectricClass"
              @mouseover="mouseOver('LOSSELECTRIC')"
              @mouseleave="mouseLeave('LOSSELECTRIC')"
              @click="openPop('LOSSELECTRIC')"
            >
              掉电报警
            </div>
          </td>
          <td>
            <div
              :class="longParkClass"
              @mouseover="mouseOver('LONGPARK')"
              @mouseleave="mouseLeave('LONGPARK')"
              @click="openPop('LONGPARK')"
            >
              超长停车
            </div>
          </td>
        ...
        <tr>
          <td>
            <div
              :class="twoAlertClass"
              @mouseover="mouseOver('TWOALERT')"
              @mouseleave="mouseLeave('TWOALERT')"
              @click="openPop('TWOALERT')"
            >
              二押点报警
            </div>
          </td>
          <td>
            <div
              :class="outProvinceClass"
              @mouseover="mouseOver('OUTPROVINCE')"
              @mouseleave="mouseLeave('OUTPROVINCE')"
              @click="openPop('OUTPROVINCE')"
            >
              出省报警
            </div>
          </td>
          <td>
            <div
              :class="unusalAlertClass"
              @mouseover="mouseOver('UNUSAL')"
              @mouseleave="mouseLeave('UNUSAL')"
              @click="openPop('UNUSAL')"
            >
              异常报警
            </div>
          </td>
          <td>
            <div
              :class="areaAlertClass"
              @mouseover="mouseOver('AREA')"
              @mouseleave="mouseLeave('AREA')"
              @click="openPop('AREA')"
            >
              区域报警
            </div>
          ...
          <td>
            <div
              :class="overSpeedAlertClass"
              @mouseover="mouseOver('OVERSPEED')"
              @mouseleave="mouseLeave('OVERSPEED')"
              @click="openPop('OVERSPEED')"
            >
              超速报警
            </div>
          </td>
          <td>
            <div
              :class="emergeAlertClass"
              @mouseover="mouseOver('EMERGE')"
              @mouseleave="mouseLeave('EMERGE')"
              @click="openPop('EMERGE')"
            >
              紧急报警
            </div>
          </td>
    ...
    <div class="chart">
      <div class="chart-left">
        <div class="chart-statuses">
          <div :class="piCarStatusClass" @click="piChartSelect(1)">
            车辆状态
          </div>
          <div :class="piCarOfflineClass" @click="piChartSelect(2)">
            离线车辆
          </div>
        </div>
